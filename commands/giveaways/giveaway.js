...
const { sub, channel, str, int, role, req } = require('../../utils/commandBuilder');
...
module.exports = {
  ...
  options: [
    sub('start', 'Start a giveaway', [
      ...
      int('winners', 'Number of winners', req({ min_value: 1, max_value: 20 })),
      role('role', 'Role required to enter', {}),
    ]),
